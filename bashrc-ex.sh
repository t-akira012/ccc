...
alias ccu='echo "Update Claude Code" && sudo npm update -g @anthropic-ai/claude-code'
alias update_all='echo "Update AI Agents" && sudo npm update -g @anthropic-ai/claude-code @openai/codex @google/gemini-cli'
